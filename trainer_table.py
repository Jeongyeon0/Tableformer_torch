...
if __name__ == '__main__':
    ...
    parser.add_argument("--tsv_path", type=str, default="data/train.tsv)
    parser.add_argument("--table_csv_path", type=str, default="table/")

    parser.add_argument("--dev_path", type=str, default="data/dev.tsv)
    parser.add_argument("--dev_result_path", type=str, default="table/")

    parser.add_argument("--test_path", type=str, default=""data/test.tsv")
    parser.add_argument("--test_result_path", type=str, default="table/")
    ...
    config = TapasConfig.from_pretrained('model/config.json')
    model = TapasForQuestionAnswering.from_pretrained('lm_tapas_pretrained/tapas_model.pt', config=config)
    tokenizer = TapasTokenizer.from_pretrained("model/", do_lower_case=False)
    optimizer = AdamW(model.parameters(), lr=5e-5)
